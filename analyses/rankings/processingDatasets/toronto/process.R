...
rankings_toronto <- df[df$ensembl_id %in% egs,]
save(rankings_toronto,
     file="../objects/rankings_toronto.rda")
rankings_toronto_neg <- df[df$ensembl_id %in% negs,]
save(rankings_toronto_neg,
     file="../objects/rankings_toronto_neg.rda")
