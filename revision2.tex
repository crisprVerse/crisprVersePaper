...
%\fixme{Whiskers ranging from minima to maxima, median and 25?75\% interquartile range (IQR) shown by boxplots}
%\fixme{Box-plot elements are defined (e.g. center line, median; box limits, upper and lower quartiles; whiskers, 1.5x interquartile range; points, outliers)}
...
\begin{figure}[!h]
\centering
\includegraphics[width=1\textwidth]{finalFigures/Figure1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.83\textwidth]{finalFigures/Figure2.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{finalFigures/Figure4.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{finalFigures/Figure5.pdf}
