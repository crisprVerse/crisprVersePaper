...
\bibitem{bagel2}
\bibinfo{author}{Kim, E.} \& \bibinfo{author}{Hart, T.}
\newblock \bibinfo{title}{Improved analysis of crispr fitness screens and
  reduced off-target effects with the bagel2 gene essentiality classifier}.
\newblock \emph{\bibinfo{journal}{Genome medicine}}
  \textbf{\bibinfo{volume}{13}}, \bibinfo{pages}{1--11} (\bibinfo{year}{2021}).

\bibitem{chronos}
\bibinfo{author}{Dempster, J.~M.} \emph{et~al.}
\newblock \bibinfo{title}{Chronos: a cell population dynamics model of crispr
  experiments that improves inference of gene fitness effects}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{22}}, \bibinfo{pages}{1--23} (\bibinfo{year}{2021}).

\bibitem{jacks}
\bibinfo{author}{Allen, F.} \emph{et~al.}
\newblock \bibinfo{title}{Jacks: joint analysis of crispr/cas9 knockout
  screens}.
\newblock \emph{\bibinfo{journal}{Genome research}}
  \textbf{\bibinfo{volume}{29}}, \bibinfo{pages}{464--471}
  (\bibinfo{year}{2019}).

\bibitem{mageckmle}
\bibinfo{author}{Li, W.} \emph{et~al.}
\newblock \bibinfo{title}{Quality control, modeling, and visualization of
  crispr screens with mageck-vispr}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{16}}, \bibinfo{pages}{1--13} (\bibinfo{year}{2015}).

\bibitem{doench2016optimized}
\bibinfo{author}{Doench, J.~G.} \emph{et~al.}
\newblock \bibinfo{title}{Optimized sgrna design to maximize activity and
  minimize off-target effects of crispr-cas9}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{34}}, \bibinfo{pages}{184} (\bibinfo{year}{2016}).

\bibitem{doench2014rational}
\bibinfo{author}{Doench, J.~G.} \emph{et~al.}
\newblock \bibinfo{title}{Rational design of highly active sgrnas for
  crispr-cas9--mediated gene inactivation}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{32}}, \bibinfo{pages}{1262} (\bibinfo{year}{2014}).
...
\newblock \bibinfo{title}{Optimized crispr guide rna design for two
  high-fidelity cas9 variants by deep learning}.
\newblock \emph{\bibinfo{journal}{Nature communications}}
  \textbf{\bibinfo{volume}{10}}, \bibinfo{pages}{1--14} (\bibinfo{year}{2019}).

\bibitem{deepcpf1}
\bibinfo{author}{Kim, H.~K.} \emph{et~al.}
\newblock \bibinfo{title}{Deep learning improves prediction of crispr--cpf1
  guide rna activity}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{36}}, \bibinfo{pages}{239} (\bibinfo{year}{2018}).

\bibitem{toronto}
\bibinfo{author}{Hart, T.} \emph{et~al.}
\newblock \bibinfo{title}{Evaluation and design of genome-wide crispr/spcas9
  knockout screens}.
\newblock \emph{\bibinfo{journal}{G3: Genes, Genomes, Genetics}}
  \textbf{\bibinfo{volume}{7}}, \bibinfo{pages}{2719--2727}
  (\bibinfo{year}{2017}).

\bibitem{crisprscan}
\bibinfo{author}{Moreno-Mateos, M.~A.} \emph{et~al.}
\newblock \bibinfo{title}{Crisprscan: designing highly efficient sgrnas for
  crispr-cas9 targeting in vivo}.
\newblock \emph{\bibinfo{journal}{Nature methods}}
  \textbf{\bibinfo{volume}{12}}, \bibinfo{pages}{982--988}
  (\bibinfo{year}{2015}).

\bibitem{crispria}
\bibinfo{author}{Horlbeck, M.~A.} \emph{et~al.}
\newblock \bibinfo{title}{Compact and highly active next-generation libraries
  for crispr-mediated gene repression and activation}.
\newblock \emph{\bibinfo{journal}{Elife}} \textbf{\bibinfo{volume}{5}},
  \bibinfo{pages}{e19760} (\bibinfo{year}{2016}).

\bibitem{fortin2019}
\bibinfo{author}{Fortin, J.-P.} \emph{et~al.}
\newblock \bibinfo{title}{Multiple-gene targeting and mismatch tolerance can
  confound analysis of genome-wide pooled crispr screens}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{20}}, \bibinfo{pages}{21} (\bibinfo{year}{2019}).

\bibitem{scott2017implications}
\bibinfo{author}{Scott, D.~A.} \& \bibinfo{author}{Zhang, F.}
\newblock \bibinfo{title}{Implications of human genetic variation in
  crispr-based therapeutic genome editing}.
\newblock \emph{\bibinfo{journal}{Nature medicine}}
  \textbf{\bibinfo{volume}{23}}, \bibinfo{pages}{1095} (\bibinfo{year}{2017}).

\bibitem{lessard2017human}
\bibinfo{author}{Lessard, S.} \emph{et~al.}
\newblock \bibinfo{title}{Human genetic variation alters crispr-cas9 on-and
  off-targeting specificity at therapeutically implicated loci}.
\newblock \emph{\bibinfo{journal}{Proceedings of the National Academy of
  Sciences}} \bibinfo{pages}{201714640} (\bibinfo{year}{2017}).

\bibitem{canver2017variant}
\bibinfo{author}{Canver, M.~C.} \emph{et~al.}
\newblock \bibinfo{title}{Variant-aware saturating mutagenesis using multiple
  cas9 nucleases identifies regulatory elements at trait-associated loci}.
\newblock \emph{\bibinfo{journal}{Nature genetics}}
  \textbf{\bibinfo{volume}{49}}, \bibinfo{pages}{625} (\bibinfo{year}{2017}).

\bibitem{wang2018genetic}
\bibinfo{author}{Wang, G.}, \bibinfo{author}{Du, M.}, \bibinfo{author}{Wang,
  J.} \& \bibinfo{author}{Zhu, T.~F.}
\newblock \bibinfo{title}{Genetic variation may confound analysis of
  crispr-cas9 off-target mutations}.
\newblock \emph{\bibinfo{journal}{Cell discovery}}
  \textbf{\bibinfo{volume}{4}}, \bibinfo{pages}{18} (\bibinfo{year}{2018}).

\bibitem{xcas9}
\bibinfo{author}{Hu, J.~H.} \emph{et~al.}
\newblock \bibinfo{title}{Evolved cas9 variants with broad pam compatibility
  and high dna specificity}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{556}},
  \bibinfo{pages}{57--63} (\bibinfo{year}{2018}).

\bibitem{spcas9ng}
\bibinfo{author}{Nishimasu, H.} \emph{et~al.}
\newblock \bibinfo{title}{Engineered crispr-cas9 nuclease with expanded
  targeting space}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{361}},
  \bibinfo{pages}{1259--1262} (\bibinfo{year}{2018}).

\bibitem{spg}
\bibinfo{author}{Walton, R.~T.}, \bibinfo{author}{Christie, K.~A.},
  \bibinfo{author}{Whittaker, M.~N.} \& \bibinfo{author}{Kleinstiver, B.~P.}
\newblock \bibinfo{title}{Unconstrained genome targeting with near-pamless
  engineered crispr-cas9 variants}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{368}},
  \bibinfo{pages}{290--296} (\bibinfo{year}{2020}).

\bibitem{enpamgb}
\bibinfo{author}{DeWeirdt, P.~C.} \emph{et~al.}
\newblock \bibinfo{title}{Optimization of ascas12a for combinatorial genetic
  screens in human cells}.
\newblock \emph{\bibinfo{journal}{Nature Biotechnology}} \bibinfo{pages}{1--11}
  (\bibinfo{year}{2020}).

\bibitem{c2c2_1}
\bibinfo{author}{Shmakov, S.} \emph{et~al.}
\newblock \bibinfo{title}{Discovery and functional characterization of diverse
  class 2 crispr-cas systems}.
\newblock \emph{\bibinfo{journal}{Molecular cell}}
  \textbf{\bibinfo{volume}{60}}, \bibinfo{pages}{385--397}
  (\bibinfo{year}{2015}).

\bibitem{c2c2_2}
\bibinfo{author}{Abudayyeh, O.~O.} \emph{et~al.}
\newblock \bibinfo{title}{C2c2 is a single-component programmable rna-guided
  rna-targeting crispr effector}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{353}}
  (\bibinfo{year}{2016}).

\bibitem{cas13d}
\bibinfo{author}{Konermann, S.} \emph{et~al.}
\newblock \bibinfo{title}{Transcriptome engineering with rna-targeting type
  vi-d crispr effectors}.
\newblock \emph{\bibinfo{journal}{Cell}} \textbf{\bibinfo{volume}{173}},
  \bibinfo{pages}{665--676} (\bibinfo{year}{2018}).

\bibitem{gaudelli}
\bibinfo{author}{Gaudelli, N.~M.} \emph{et~al.}
\newblock \bibinfo{title}{Programmable base editing of a* t to g* c in genomic
  dna without dna cleavage}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{551}},
  \bibinfo{pages}{464--471} (\bibinfo{year}{2017}).

\bibitem{komor}
\bibinfo{author}{Komor, A.~C.}, \bibinfo{author}{Kim, Y.~B.},
  \bibinfo{author}{Packer, M.~S.}, \bibinfo{author}{Zuris, J.~A.} \&
  \bibinfo{author}{Liu, D.~R.}
\newblock \bibinfo{title}{Programmable editing of a target base in genomic dna
  without double-stranded dna cleavage}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{533}},
  \bibinfo{pages}{420--424} (\bibinfo{year}{2016}).

\bibitem{rnaediting1}
\bibinfo{author}{Cox, D.~B.} \emph{et~al.}
\newblock \bibinfo{title}{Rna editing with crispr-cas13}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{358}},
  \bibinfo{pages}{1019--1027} (\bibinfo{year}{2017}).

\bibitem{ops}
\bibinfo{author}{Feldman, D.} \emph{et~al.}
\newblock \bibinfo{title}{Optical pooled screens in human cells}.
\newblock \emph{\bibinfo{journal}{Cell}} \textbf{\bibinfo{volume}{179}},
  \bibinfo{pages}{787--799} (\bibinfo{year}{2019}).

\bibitem{ecrisp}
\bibinfo{author}{Heigwer, F.}, \bibinfo{author}{Kerr, G.} \&
  \bibinfo{author}{Boutros, M.}
\newblock \bibinfo{title}{E-crisp: fast crispr target site identification}.
\newblock \emph{\bibinfo{journal}{Nature methods}}
  \textbf{\bibinfo{volume}{11}}, \bibinfo{pages}{122--123}
  (\bibinfo{year}{2014}).

\bibitem{guidescan}
\bibinfo{author}{Perez, A.~R.} \emph{et~al.}
\newblock \bibinfo{title}{Guidescan software for improved single and paired
  crispr guide rna design}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{35}}, \bibinfo{pages}{347--349}
  (\bibinfo{year}{2017}).

\bibitem{casoffinder}
\bibinfo{author}{Bae, S.}, \bibinfo{author}{Park, J.} \& \bibinfo{author}{Kim,
  J.-S.}
\newblock \bibinfo{title}{Cas-offinder: a fast and versatile algorithm that
  searches for potential off-target sites of cas9 rna-guided endonucleases}.
\newblock \emph{\bibinfo{journal}{Bioinformatics}}
  \textbf{\bibinfo{volume}{30}}, \bibinfo{pages}{1473--1475}
  (\bibinfo{year}{2014}).

\bibitem{chopchop}
\bibinfo{author}{Montague, T.~G.}, \bibinfo{author}{Cruz, J.~M.},
  \bibinfo{author}{Gagnon, J.~A.}, \bibinfo{author}{Church, G.~M.} \&
  \bibinfo{author}{Valen, E.}
\newblock \bibinfo{title}{Chopchop: a crispr/cas9 and talen web tool for genome
  editing}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{42}}, \bibinfo{pages}{W401--W407}
  (\bibinfo{year}{2014}).

\bibitem{crispor}
\bibinfo{author}{Concordet, J.-P.} \& \bibinfo{author}{Haeussler, M.}
\newblock \bibinfo{title}{Crispor: intuitive guide selection for crispr/cas9
  genome editing experiments and screens}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{46}}, \bibinfo{pages}{W242--W245}
  (\bibinfo{year}{2018}).

\bibitem{cctop}
\bibinfo{author}{Stemmer, M.}, \bibinfo{author}{Thumberger, T.},
  \bibinfo{author}{del Sol~Keyer, M.}, \bibinfo{author}{Wittbrodt, J.} \&
  \bibinfo{author}{Mateo, J.~L.}
\newblock \bibinfo{title}{Cctop: an intuitive, flexible and reliable
  crispr/cas9 target prediction tool}.
\newblock \emph{\bibinfo{journal}{PloS one}} \textbf{\bibinfo{volume}{10}},
  \bibinfo{pages}{e0124633} (\bibinfo{year}{2015}).

\bibitem{flashfry}
\bibinfo{author}{McKenna, A.} \& \bibinfo{author}{Shendure, J.}
\newblock \bibinfo{title}{Flashfry: a fast and flexible tool for large-scale
  crispr target design}.
\newblock \emph{\bibinfo{journal}{BMC biology}} \textbf{\bibinfo{volume}{16}},
  \bibinfo{pages}{1--6} (\bibinfo{year}{2018}).

\bibitem{cld}
\bibinfo{author}{Heigwer, F.} \emph{et~al.}
\newblock \bibinfo{title}{Crispr library designer (cld): software for
  multispecies design of single guide rna libraries}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{17}}, \bibinfo{pages}{1--10} (\bibinfo{year}{2016}).

\bibitem{multicrispr}
\bibinfo{author}{Bhagwat, A.~M.} \emph{et~al.}
\newblock \bibinfo{title}{multicrispr: grna design for prime editing and
  parallel targeting of thousands of targets}.
\newblock \emph{\bibinfo{journal}{Life science alliance}}
  \textbf{\bibinfo{volume}{3}} (\bibinfo{year}{2020}).

\bibitem{crisprseek}
\bibinfo{author}{Zhu, L.~J.}, \bibinfo{author}{Holmes, B.~R.},
  \bibinfo{author}{Aronin, N.} \& \bibinfo{author}{Brodsky, M.~H.}
\newblock \bibinfo{title}{Crisprseek: a bioconductor package to identify
  target-specific guide rnas for crispr-cas9 genome-editing systems}.
\newblock \emph{\bibinfo{journal}{PloS one}} \textbf{\bibinfo{volume}{9}},
  \bibinfo{pages}{e108424} (\bibinfo{year}{2014}).

\bibitem{bioc1}
\bibinfo{author}{Gentleman, R.~C.} \emph{et~al.}
\newblock \bibinfo{title}{Bioconductor: open software development for
  computational biology and bioinformatics}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{5}}, \bibinfo{pages}{1--16} (\bibinfo{year}{2004}).

\bibitem{bioc2}
\bibinfo{author}{Huber, W.} \emph{et~al.}
\newblock \bibinfo{title}{Orchestrating high-throughput genomic analysis with
  bioconductor}.
\newblock \emph{\bibinfo{journal}{Nature methods}}
  \textbf{\bibinfo{volume}{12}}, \bibinfo{pages}{115--121}
  (\bibinfo{year}{2015}).

\bibitem{guides}
\bibinfo{author}{Meier, J.~A.}, \bibinfo{author}{Zhang, F.} \&
  \bibinfo{author}{Sanjana, N.~E.}
\newblock \bibinfo{title}{Guides: sgrna design for loss-of-function screens}.
\newblock \emph{\bibinfo{journal}{Nature methods}}
  \textbf{\bibinfo{volume}{14}}, \bibinfo{pages}{831--832}
  (\bibinfo{year}{2017}).

\bibitem{casdesigner}
\bibinfo{author}{Park, J.}, \bibinfo{author}{Bae, S.} \& \bibinfo{author}{Kim,
  J.-S.}
\newblock \bibinfo{title}{Cas-designer: a web-based tool for choice of
  crispr-cas9 target sites}.
\newblock \emph{\bibinfo{journal}{Bioinformatics}}
  \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{4014--4016}
  (\bibinfo{year}{2015}).

\bibitem{genomicranges}
\bibinfo{author}{Lawrence, M.} \emph{et~al.}
\newblock \bibinfo{title}{Software for computing and annotating genomic
  ranges}.
\newblock \emph{\bibinfo{journal}{PLoS computational biology}}
  \textbf{\bibinfo{volume}{9}}, \bibinfo{pages}{e1003118}
  (\bibinfo{year}{2013}).

\bibitem{granges}
\bibinfo{author}{Aboyoun, P.}, \bibinfo{author}{Pages, H.} \&
  \bibinfo{author}{Lawrence, M.}
\newblock \emph{\bibinfo{title}{GenomicRanges: Representation and manipulation
  of genomic intervals}} (\bibinfo{year}{2012}).

\bibitem{deepspcas9}
\bibinfo{author}{Kim, H.~K.} \emph{et~al.}
\newblock \bibinfo{title}{Spcas9 activity prediction by deepspcas9, a deep
  learning--based model with high generalization performance}.
\newblock \emph{\bibinfo{journal}{Science advances}}
  \textbf{\bibinfo{volume}{5}}, \bibinfo{pages}{eaax9249}
  (\bibinfo{year}{2019}).

\bibitem{lindel}
\bibinfo{author}{Chen, W.} \emph{et~al.}
\newblock \bibinfo{title}{Massively parallel profiling and predictive modeling
  of the outcomes of crispr/cas9-mediated double-strand break repair}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{47}}, \bibinfo{pages}{7989--8003}
  (\bibinfo{year}{2019}).

\bibitem{wessels2020massively}
\bibinfo{author}{Wessels, H.-H.} \emph{et~al.}
\newblock \bibinfo{title}{Massively parallel cas13 screens reveal principles
  for guide rna design}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{38}}, \bibinfo{pages}{722--727}
  (\bibinfo{year}{2020}).

\bibitem{crisprater}
\bibinfo{author}{Labuhn, M.} \emph{et~al.}
\newblock \bibinfo{title}{Refined sgrna efficacy prediction improves large-and
  small-scale crispr--cas9 applications}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{46}}, \bibinfo{pages}{1375--1385}
  (\bibinfo{year}{2018}).

\bibitem{basilisk}
\bibinfo{author}{Lun, A.}
\newblock \emph{\bibinfo{title}{basilisk: Freezing Python Dependencies Inside
  Bioconductor Packages}} (\bibinfo{year}{2021}).
\newblock \bibinfo{note}{R package version 1.3.5}.

\bibitem{offtarget1}
\bibinfo{author}{Fu, Y.} \emph{et~al.}
\newblock \bibinfo{title}{High-frequency off-target mutagenesis induced by
  crispr-cas nucleases in human cells}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{822--826}
  (\bibinfo{year}{2013}).

\bibitem{offtarget2}
\bibinfo{author}{Hsu, P.~D.} \emph{et~al.}
\newblock \bibinfo{title}{Dna targeting specificity of rna-guided cas9
  nucleases}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{827--832}
  (\bibinfo{year}{2013}).

\bibitem{offtarget3}
\bibinfo{author}{Pattanayak, V.} \emph{et~al.}
\newblock \bibinfo{title}{High-throughput profiling of off-target dna cleavage
  reveals rna-programmed cas9 nuclease specificity}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{839--843}
  (\bibinfo{year}{2013}).

\bibitem{bowtie}
\bibinfo{author}{Langmead, B.}, \bibinfo{author}{Trapnell, C.},
  \bibinfo{author}{Pop, M.} \& \bibinfo{author}{Salzberg, S.~L.}
\newblock \bibinfo{title}{Ultrafast and memory-efficient alignment of short dna
  sequences to the human genome}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{10}}, \bibinfo{pages}{R25} (\bibinfo{year}{2009}).

\bibitem{bwa}
\bibinfo{author}{Li, H.} \& \bibinfo{author}{Durbin, R.}
\newblock \bibinfo{title}{Fast and accurate short read alignment with
  burrows--wheeler transform}.
\newblock \emph{\bibinfo{journal}{bioinformatics}}
  \textbf{\bibinfo{volume}{25}}, \bibinfo{pages}{1754--1760}
  (\bibinfo{year}{2009}).

\bibitem{aho1975efficient}
\bibinfo{author}{Aho, A.~V.} \& \bibinfo{author}{Corasick, M.~J.}
\newblock \bibinfo{title}{Efficient string matching: an aid to bibliographic
  search}.
\newblock \emph{\bibinfo{journal}{Communications of the ACM}}
  \textbf{\bibinfo{volume}{18}}, \bibinfo{pages}{333--340}
  (\bibinfo{year}{1975}).

\bibitem{pages2016biostrings}
\bibinfo{author}{Pages, H.}, \bibinfo{author}{Aboyoun, P.},
  \bibinfo{author}{Gentleman, R.} \& \bibinfo{author}{DebRoy, S.}
\newblock \bibinfo{title}{Biostrings: String objects representing biological
  sequences, and matching algorithms}.
\newblock \emph{\bibinfo{journal}{R package version}}
  \textbf{\bibinfo{volume}{2}}, \bibinfo{pages}{10--18129}
  (\bibinfo{year}{2016}).
...
\newblock \bibinfo{title}{Dna targeting specificity of rna-guided cas9
  nucleases}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{827} (\bibinfo{year}{2013}).

\bibitem{smits2019biological}
\bibinfo{author}{Smits, A.~H.} \emph{et~al.}
\newblock \bibinfo{title}{Biological plasticity rescues target activity in
  crispr knock outs}.
\newblock \emph{\bibinfo{journal}{Nature methods}}
  \textbf{\bibinfo{volume}{16}}, \bibinfo{pages}{1087--1093}
  (\bibinfo{year}{2019}).

\bibitem{cohen2019nonsense}
\bibinfo{author}{Cohen, S.} \emph{et~al.}
\newblock \bibinfo{title}{Nonsense mutation-dependent reinitiation of
  translation in mammalian cells}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{47}}, \bibinfo{pages}{6330--6338}
  (\bibinfo{year}{2019}).

\bibitem{he2019novo}
\bibinfo{author}{He, W.} \emph{et~al.}
\newblock \bibinfo{title}{De novo identification of essential protein domains
  from crispr-cas9 tiling-sgrna knockout screens}.
\newblock \emph{\bibinfo{journal}{Nature communications}}
  \textbf{\bibinfo{volume}{10}}, \bibinfo{pages}{1--10} (\bibinfo{year}{2019}).

\bibitem{pfam}
\bibinfo{author}{Bateman, A.} \emph{et~al.}
\newblock \bibinfo{title}{The pfam protein families database}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{32}}, \bibinfo{pages}{D138--D141}
  (\bibinfo{year}{2004}).
...
\bibitem{rtracklayer}
\bibinfo{author}{Lawrence, M.}, \bibinfo{author}{Gentleman, R.} \&
  \bibinfo{author}{Carey, V.}
\newblock \bibinfo{title}{rtracklayer: an r package for interfacing with genome
  browsers}.
\newblock \emph{\bibinfo{journal}{Bioinformatics}}
  \textbf{\bibinfo{volume}{25}}, \bibinfo{pages}{1841--1842}
  (\bibinfo{year}{2009}).

\bibitem{chen2018improved}
\bibinfo{author}{Chen, C.-H.} \emph{et~al.}
\newblock \bibinfo{title}{Improved design and analysis of crispr knockout
  screens}.
\newblock \emph{\bibinfo{journal}{Bioinformatics}}  (\bibinfo{year}{2018}).

\bibitem{wang2014genetic}
\bibinfo{author}{Wang, T.}, \bibinfo{author}{Wei, J.~J.},
  \bibinfo{author}{Sabatini, D.~M.} \& \bibinfo{author}{Lander, E.~S.}
\newblock \bibinfo{title}{Genetic screens in human cells using the crispr/cas9
  system}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{343}},
  \bibinfo{pages}{80--84} (\bibinfo{year}{2014}).

\bibitem{gilbert2014genomescale}
\bibinfo{author}{Gilbert, L.~A.} \emph{et~al.}
\newblock \bibinfo{title}{Genome-scale crispr-mediated control of gene
  repression and activation}.
\newblock \emph{\bibinfo{journal}{Cell}} \textbf{\bibinfo{volume}{159}},
  \bibinfo{pages}{647--661} (\bibinfo{year}{2014}).

\bibitem{pincer}
\bibinfo{author}{Veeneman, B.} \emph{et~al.}
\newblock \bibinfo{title}{Pincer: improved crispr/cas9 screening by efficient
  cleavage at conserved residues}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{48}}, \bibinfo{pages}{9462--9477}
  (\bibinfo{year}{2020}).

\bibitem{thyme2016internal}
\bibinfo{author}{Thyme, S.~B.}, \bibinfo{author}{Akhmetova, L.},
  \bibinfo{author}{Montague, T.~G.}, \bibinfo{author}{Valen, E.} \&
  \bibinfo{author}{Schier, A.~F.}
\newblock \bibinfo{title}{Internal guide rna interactions interfere with
  cas9-mediated cleavage}.
\newblock \emph{\bibinfo{journal}{Nature communications}}
  \textbf{\bibinfo{volume}{7}}, \bibinfo{pages}{11750} (\bibinfo{year}{2016}).

\bibitem{labun2016chopchop}
\bibinfo{author}{Labun, K.}, \bibinfo{author}{Montague, T.~G.},
  \bibinfo{author}{Gagnon, J.~A.}, \bibinfo{author}{Thyme, S.~B.} \&
  \bibinfo{author}{Valen, E.}
\newblock \bibinfo{title}{Chopchop v2: a web tool for the next generation of
  crispr genome engineering}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{44}}, \bibinfo{pages}{W272--W276}
  (\bibinfo{year}{2016}).

\bibitem{gviz}
\bibinfo{author}{Hahne, F.} \& \bibinfo{author}{Ivanek, R.}
\newblock \emph{\bibinfo{title}{Visualizing genomic data using Gviz and
  bioconductor}} (\bibinfo{publisher}{Springer}, \bibinfo{year}{2016}).

\bibitem{pollard2010detection}
\bibinfo{author}{Pollard, K.~S.}, \bibinfo{author}{Hubisz, M.~J.},
  \bibinfo{author}{Rosenbloom, K.~R.} \& \bibinfo{author}{Siepel, A.}
\newblock \bibinfo{title}{Detection of nonneutral substitution rates on
  mammalian phylogenies}.
\newblock \emph{\bibinfo{journal}{Genome research}}
  \textbf{\bibinfo{volume}{20}}, \bibinfo{pages}{110--121}
  (\bibinfo{year}{2010}).

\bibitem{hart2014}
\bibinfo{author}{Hart, T.}, \bibinfo{author}{Brown, K.~R.},
  \bibinfo{author}{Sircoulomb, F.}, \bibinfo{author}{Rottapel, R.} \&
  \bibinfo{author}{Moffat, J.}
\newblock \bibinfo{title}{Measuring error rates in genomic perturbation
  screens: gold standards for human functional genomics}.
\newblock \emph{\bibinfo{journal}{Molecular systems biology}}
  \textbf{\bibinfo{volume}{10}}, \bibinfo{pages}{733} (\bibinfo{year}{2014}).

\bibitem{crispro}
\bibinfo{author}{Schoonenberg, V.~A.} \emph{et~al.}
\newblock \bibinfo{title}{Crispro: identification of functional protein coding
  sequences based on genome editing dense mutagenesis}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{19}}, \bibinfo{pages}{1--19} (\bibinfo{year}{2018}).

\bibitem{ruleset3}
\bibinfo{author}{DeWeirdt, P.~C.} \emph{et~al.}
\newblock \bibinfo{title}{Accounting for small variations in the tracrrna
  sequence improves sgrna activity predictions for crispr screening}.
\newblock \emph{\bibinfo{journal}{Nature Communications}}
  \textbf{\bibinfo{volume}{13}}, \bibinfo{pages}{5255} (\bibinfo{year}{2022}).
\newblock \urlprefix\url{https://doi.org/10.1038/s41467-022-33024-2}.

\bibitem{behive}
\bibinfo{author}{Arbab, M.} \emph{et~al.}
\newblock \bibinfo{title}{Determinants of base editing outcomes from target
  library analysis and machine learning}.
\newblock \emph{\bibinfo{journal}{Cell}} \textbf{\bibinfo{volume}{182}},
  \bibinfo{pages}{463--480} (\bibinfo{year}{2020}).

\bibitem{koblan2018improving}
\bibinfo{author}{Koblan, L.~W.} \emph{et~al.}
\newblock \bibinfo{title}{Improving cytidine and adenine base editors by
  expression optimization and ancestral reconstruction}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{36}}, \bibinfo{pages}{843--846}
  (\bibinfo{year}{2018}).

\bibitem{hanna2021massively}
\bibinfo{author}{Hanna, R.~E.} \emph{et~al.}
\newblock \bibinfo{title}{Massively parallel assessment of human variants with
  base editor screens}.
\newblock \emph{\bibinfo{journal}{Cell}} \textbf{\bibinfo{volume}{184}},
  \bibinfo{pages}{1064--1080} (\bibinfo{year}{2021}).

\bibitem{findlay2018accurate}
\bibinfo{author}{Findlay, G.~M.} \emph{et~al.}
\newblock \bibinfo{title}{Accurate classification of brca1 variants with
  saturation genome editing}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{562}},
  \bibinfo{pages}{217--222} (\bibinfo{year}{2018}).

\bibitem{radzisheuskaya2016optimizing}
\bibinfo{author}{Radzisheuskaya, A.}, \bibinfo{author}{Shlyueva, D.},
  \bibinfo{author}{M{\"u}ller, I.} \& \bibinfo{author}{Helin, K.}
\newblock \bibinfo{title}{Optimizing sgrna position markedly improves the
  efficiency of crispr/dcas9-mediated transcriptional repression}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{44}}, \bibinfo{pages}{e141--e141}
  (\bibinfo{year}{2016}).

\bibitem{sanson2018optimized}
\bibinfo{author}{Sanson, K.~R.} \emph{et~al.}
\newblock \bibinfo{title}{Optimized libraries for crispr-cas9 genetic screens
  with multiple modalities}.
\newblock \emph{\bibinfo{journal}{Nature communications}}
  \textbf{\bibinfo{volume}{9}}, \bibinfo{pages}{1--15} (\bibinfo{year}{2018}).

\bibitem{kundaje2015integrative}
\bibinfo{author}{Kundaje, A.} \emph{et~al.}
\newblock \bibinfo{title}{Integrative analysis of 111 reference human
  epigenomes}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{518}},
  \bibinfo{pages}{317--330} (\bibinfo{year}{2015}).

\bibitem{kuscu2014genome}
\bibinfo{author}{Kuscu, C.}, \bibinfo{author}{Arslan, S.},
  \bibinfo{author}{Singh, R.}, \bibinfo{author}{Thorpe, J.} \&
  \bibinfo{author}{Adli, M.}
\newblock \bibinfo{title}{Genome-wide analysis reveals characteristics of
  off-target sites bound by the cas9 endonuclease}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{32}}, \bibinfo{pages}{677--683}
  (\bibinfo{year}{2014}).

\bibitem{wu2014genome}
\bibinfo{author}{Wu, X.} \emph{et~al.}
\newblock \bibinfo{title}{Genome-wide binding of the crispr endonuclease cas9
  in mammalian cells}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{32}}, \bibinfo{pages}{670--676}
  (\bibinfo{year}{2014}).

\bibitem{liu2017crispri}
\bibinfo{author}{Liu, S.~J.} \emph{et~al.}
\newblock \bibinfo{title}{Crispri-based genome-scale identification of
  functional long noncoding rna loci in human cells}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{355}},
  \bibinfo{pages}{eaah7111} (\bibinfo{year}{2017}).

\bibitem{sangree2021benchmarking}
\bibinfo{author}{Sangree, A.~K.} \emph{et~al.}
\newblock \bibinfo{title}{Benchmarking of spcas9 variants enables deeper base
  editor screens of brca1 and bcl2}.
\newblock \emph{\bibinfo{journal}{bioRxiv}}  (\bibinfo{year}{2021}).

\bibitem{labun2019accurate}
\bibinfo{author}{Labun, K.} \emph{et~al.}
\newblock \bibinfo{title}{Accurate analysis of genuine crispr editing events
  with amplican}.
\newblock \emph{\bibinfo{journal}{Genome research}}
  \textbf{\bibinfo{volume}{29}}, \bibinfo{pages}{843--847}
  (\bibinfo{year}{2019}).

\bibitem{zhu2017guideseq}
\bibinfo{author}{Zhu, L.~J.} \emph{et~al.}
\newblock \bibinfo{title}{Guideseq: a bioconductor package to analyze guide-seq
  datasets for crispr-cas nucleases}.
\newblock \emph{\bibinfo{journal}{BMC genomics}} \textbf{\bibinfo{volume}{18}},
  \bibinfo{pages}{1--10} (\bibinfo{year}{2017}).

\bibitem{lindsay2016crisprvariants}
\bibinfo{author}{Lindsay, H.} \emph{et~al.}
\newblock \bibinfo{title}{Crisprvariants charts the mutation spectrum of genome
  engineering experiments}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{34}}, \bibinfo{pages}{701--702}
  (\bibinfo{year}{2016}).

\bibitem{wang2019integrative}
\bibinfo{author}{Wang, B.} \emph{et~al.}
\newblock \bibinfo{title}{Integrative analysis of pooled crispr genetic screens
  using mageckflute}.
\newblock \emph{\bibinfo{journal}{Nature protocols}}
  \textbf{\bibinfo{volume}{14}}, \bibinfo{pages}{756--780}
  (\bibinfo{year}{2019}).

\bibitem{imkeller2020gscreend}
\bibinfo{author}{Imkeller, K.}, \bibinfo{author}{Ambrosi, G.},
  \bibinfo{author}{Boutros, M.} \& \bibinfo{author}{Huber, W.}
\newblock \bibinfo{title}{gscreend: modelling asymmetric count ratios in crispr
  screens to decrease experiment size and improve phenotype detection}.
\newblock \emph{\bibinfo{journal}{Genome biology}}
  \textbf{\bibinfo{volume}{21}}, \bibinfo{pages}{1--13} (\bibinfo{year}{2020}).

\bibitem{gcrisprtools}
\bibinfo{author}{Bainer, R.}, \bibinfo{author}{Ratman, D.},
  \bibinfo{author}{Haverty, P.} \& \bibinfo{author}{Lianoglou, S.}
\newblock \emph{\bibinfo{title}{gCrisprTools: Suite of Functions for Pooled
  Crispr Screen QC and Analysis}} (\bibinfo{year}{2021}).
\newblock \bibinfo{note}{R package version 2.0.0}.

\bibitem{primeediting}
\bibinfo{author}{Anzalone, A.~V.} \emph{et~al.}
\newblock \bibinfo{title}{Search-and-replace genome editing without
  double-strand breaks or donor dna}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{576}},
  \bibinfo{pages}{149--157} (\bibinfo{year}{2019}).

\bibitem{replogle2020combinatorial}
\bibinfo{author}{Replogle, J.~M.} \emph{et~al.}
\newblock \bibinfo{title}{Combinatorial single-cell crispr screens by direct
  guide rna capture and targeted sequencing}.
\newblock \emph{\bibinfo{journal}{Nature biotechnology}}
  \textbf{\bibinfo{volume}{38}}, \bibinfo{pages}{954--961}
  (\bibinfo{year}{2020}).

\bibitem{hahne2012rbowtie}
\bibinfo{author}{Hahne, F.}, \bibinfo{author}{Lerch, A.} \&
  \bibinfo{author}{Stadler, M.}
\newblock \bibinfo{title}{Rbowtie: A r wrapper for bowtie and splicemap short
  read aligners}.
\newblock \emph{\bibinfo{journal}{URL http://bioconductor.
  org/packages/release/bioc/html/Rbowtie. html}}  (\bibinfo{year}{2012}).

\bibitem{djebali2012landscape}
\bibinfo{author}{Djebali, S.} \emph{et~al.}
\newblock \bibinfo{title}{Landscape of transcription in human cells}.
\newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{489}},
  \bibinfo{pages}{101--108} (\bibinfo{year}{2012}).

\bibitem{ucsc}
\bibinfo{author}{Karolchik, D.} \emph{et~al.}
\newblock \bibinfo{title}{The ucsc genome browser database}.
\newblock \emph{\bibinfo{journal}{Nucleic acids research}}
  \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{51--54}
  (\bibinfo{year}{2003}).

\bibitem{bsgenome_major}
\bibinfo{author}{Fortin, J.-P.}
\newblock \emph{\bibinfo{title}{BSgenome.Hsapiens.UCSC.hg38.dbSNP151.major:
  Full genome sequences for Homo sapiens (UCSC version hg38, based on
  GRCh38.p12) with injected major alleles (dbSNP151)}} (\bibinfo{year}{2021}).
\newblock \bibinfo{note}{R package version 0.0.9999}.

\bibitem{bsgenome_minor}
\bibinfo{author}{Fortin, J.-P.}
\newblock \emph{\bibinfo{title}{BSgenome.Hsapiens.UCSC.hg38.dbSNP151.minor:
  Full genome sequences for Homo sapiens (UCSC version hg38, based on
  GRCh38.p12) with injected minor alleles (dbSNP151)}} (\bibinfo{year}{2021}).
\newblock \bibinfo{note}{R package version 0.0.9999}.

\bibitem{toronto1}
\bibinfo{author}{Hart, T.} \emph{et~al.}
\newblock \bibinfo{title}{High-resolution crispr screens reveal fitness genes
  and genotype-specific cancer liabilities}.
\newblock \emph{\bibinfo{journal}{Cell}} \textbf{\bibinfo{volume}{163}},
  \bibinfo{pages}{1515--1526} (\bibinfo{year}{2015}).
...
\bibitem{sabatini}
\bibinfo{author}{Wang, T.} \emph{et~al.}
\newblock \bibinfo{title}{Identification and characterization of essential
  genes in the human genome}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{350}},
  \bibinfo{pages}{1096--1101} (\bibinfo{year}{2015}).

\bibitem{yusa}
\bibinfo{author}{Tzelepis, K.} \emph{et~al.}
\newblock \bibinfo{title}{A crispr dropout screen identifies genetic
  vulnerabilities and therapeutic targets in acute myeloid leukemia}.
\newblock \emph{\bibinfo{journal}{Cell reports}} \textbf{\bibinfo{volume}{17}},
  \bibinfo{pages}{1193--1205} (\bibinfo{year}{2016}).

\bibitem{konstantakos2022crispr}
\bibinfo{author}{Konstantakos, V.}, \bibinfo{author}{Nentidis, A.},
  \bibinfo{author}{Krithara, A.} \& \bibinfo{author}{Paliouras, G.}
\newblock \bibinfo{title}{Crispr--cas9 grna efficiency prediction: an overview
  of predictive tools and the role of deep learning}.
\newblock \emph{\bibinfo{journal}{Nucleic Acids Research}}
  \textbf{\bibinfo{volume}{50}}, \bibinfo{pages}{3616--3637}
  (\bibinfo{year}{2022}).

\bibitem{crisprScore}
\bibinfo{author}{Fortin, J.-P.} \& \bibinfo{author}{Lun, A.}
\newblock \emph{\bibinfo{title}{crisprScore: On-Target and Off-Target Scoring
  Algorithms for CRISPR gRNAs}} (\bibinfo{year}{2022}).
\newblock \urlprefix\url{https://github.com/Jfortin1/crisprScore/issues}.
\newblock \bibinfo{note}{R package version 0.99.16}.
